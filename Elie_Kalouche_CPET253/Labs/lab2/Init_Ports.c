...
void Port1_Init(void){
   P1DIR &= 0b11101101; //Makes Port1 pins 1 and 4 to inputs(0)
   P1REN |= 0b00010010; //Makes Port1 pins 1 and 4 to enable Pullup
   P1OUT |= 0b00010010; //Makes Port1 pins 1 and 4 to output Pullup
...
void Port2_Init(void){
    P2DIR |= 0b00000111; //Makes Port2 pins 0,1 and 2 to be outputs(1)
    P2OUT &= 0b11111000; // Turns off All led 2 lights
